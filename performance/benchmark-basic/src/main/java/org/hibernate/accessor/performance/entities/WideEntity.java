...
/**
 * A wide entity with 32 properties (alternating {@code int} and {@link String}), each reachable
 * via field and getter/setter. Used by the bulk (multi-value) benchmarks across several arities.
 */
public class WideEntity {

	public static final int MEMBER_COUNT = 32;
